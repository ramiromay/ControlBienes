...
namespace ControlBienes.Web.Controllers.Patrimonio
{
	...
	public class InventarioInmuebleController : ControllerBase
	{
		private readonly IBusInventarioInmueble _servicio;

		public InventarioInmuebleController(IBusInventarioInmueble servicio)
		{
			_servicio = servicio;
		}
