...
namespace ControlBienes.Web.Controllers.Patrimonio
{
	...
	public class InventarioMuebleController : ControllerBase
	{
		private readonly IBusInventarioMueble _servicio;

		public InventarioMuebleController(IBusInventarioMueble servicio)
		{
			_servicio = servicio;
		}

		[HttpGet("{idBien}")]
		[AutorizacionSICBA(EnumPermiso.VisualizacionInventarioBienesMuebles)]
