...
{
	public class BusSolicitudInmuebleMapping : Profile
	{
		public BusSolicitudInmuebleMapping()
		{
			CreateMap<EntSolicitud, EntSolicitudInmuebleResponse>()
				...
				.ForMember(dest => dest.DocumentoReferencia, opt => opt.MapFrom(src => src.sDocumentoReferencia))
			...
			CreateMap<EntSolicitudInmuebleRequest, EntSolicitud>()
				...
				.ForMember(dest => dest.sDocumentoReferencia, opt => opt.MapFrom(src => src.DocumentoReferencia))
			   ...
			   .ForMember(dest => dest.iIdTipoBien, opt => opt.MapFrom(src => (long)EnumTipoBien.Inmueble))
