...
{
	public class BusTramiteMuebleModificacionValidator : AbstractValidator<EntDetalleModificacionMuebleRequest>
	{
		public BusTramiteMuebleModificacionValidator()
		{
			...
			RuleFor(request => request.PrecioUnitario)
			   .Cascade(CascadeMode.Stop)
			   .Must(e => e > 0.00m).WithMessage("El Precio Unitario debe ser mayor a 0.00");
