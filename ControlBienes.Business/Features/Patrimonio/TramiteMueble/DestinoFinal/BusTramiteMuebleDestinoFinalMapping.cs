...
namespace ControlBienes.Business.Features.Patrimonio.TramiteMueble.DestinoFinal
{
	public class BusTramiteMuebleDestinoFinalMapping : Profile
	{
		public BusTramiteMuebleDestinoFinalMapping()
		{
			CreateMap<EntDetalleSolicitud, EntDetalleDestinoFinalMuebleResponse>()
			...
			CreateMap<EntDetalleDestinoFinalMuebleRequest, EntDetalleSolicitud>()
				...
				.ForPath(dest => dest.DetalleDestinoFinal.iIdTipoBien, opt => opt.MapFrom(src => (long)EnumTipoBien.Mueble))
