...
{
	public class BusSolicitudVehiculoMapping : Profile
	{
		public BusSolicitudVehiculoMapping()
		{
			CreateMap<EntSolicitud, EntSolicitudVehiculoResponse>()
			...
			CreateMap<EntSolicitudVehiculoRequest, EntSolicitud>()
			   ...
			   .ForMember(dest => dest.iIdTipoBien, opt => opt.MapFrom(src => (long)EnumTipoBien.MaquinariaVehiculo))
