...
namespace ControlBienes.Business.Features.Catalogos.Ubicacion
{
    public class BusUbicacion : IBusUbicacion
    {
        ...
        public async Task<EntityResponse<IEnumerable<EntUbicacionResponse>>> BObtenerTodosAsync(bool? activo)
        {
            var nombreMetodo = nameof(BObtenerTodosAsync);
            ...
            try
            {
				Expression<Func<EntUbicacion, bool>>? predicado = activo.HasValue
