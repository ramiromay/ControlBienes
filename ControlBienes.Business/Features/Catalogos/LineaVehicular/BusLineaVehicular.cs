...
namespace ControlBienes.Business.Features.Catalogos.LineaVehicular
{
    public class BusLineaVehicular : IBusLineaVehicular
    {
        ...
        public async Task<EntityResponse<IEnumerable<EntLineaVehicularResponse>>> BObtenerTodosAsync(bool? activo)
        {
            string nombreMetodo = nameof(this.BObtenerTodosAsync);
            ...
            try
            {
				Expression<Func<EntLineaVehicular, bool>>? predicado = activo.HasValue
